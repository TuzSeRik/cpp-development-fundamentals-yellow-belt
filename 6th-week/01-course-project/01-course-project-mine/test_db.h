...
// Tests, copied from discussion forum. Doesn't check date format correctly
...
class AlwaysFalseNode : public Node {
    [[nodiscard]] bool Evaluate(const Date&, const std::string& event) const override {
        return false;
    }
};
...
[[maybe_unused]] void TestDateComparisonNode() {
    {
...
[[maybe_unused]] void TestEventComparisonNode() {
    {
...
[[maybe_unused]] void TestLogicalOperationNode() {
    {
